...
public class GlobalConstants {
  public static final String BATCH_JOB_CSV_FILE_PATH = "csvFilePath";
  public static final String BATCH_JOB_JSON_FILE_PATH = "jsonFilePath";
  public static final String BATCH_JOB_CSV_FILE_NAME = "fname";
  public static final String BATCH_JOB_DATE = "date";
